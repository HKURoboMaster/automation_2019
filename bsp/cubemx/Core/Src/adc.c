#include "adc.h"
/* Edited By Eric Chen Add Voltage read and Current Read Feature */
extern ADC_HandleTypeDef hadc1; // Voltage measurement Pin N2
extern ADC_HandleTypeDef hadc2; // Current measurement Pin O2
