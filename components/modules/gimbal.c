...
int32_t gimbal_cascade_register(struct gimbal *gimbal, const char *name, enum device_can can)
{
  ...
  pid_struct_init(&(gimbal->cascade[YAW_MOTOR_INDEX].outer), 500, 600, 35, 0, 0);
	//pid_struct_init(&(gimbal->cascade[YAW_MOTOR_INDEX].outer), 500, 600, 80, 0, 0);
  pid_struct_init(&(gimbal->cascade[YAW_MOTOR_INDEX].inter), 20000, 3000, 140, 0, 0);
  ...
  pid_struct_init(&(gimbal->cascade[PITCH_MOTOR_INDEX].outer), 500, 0, 18, 0, 0);
  pid_struct_init(&(gimbal->cascade[PITCH_MOTOR_INDEX].inter), 6000, 8000, 60, 0, 0);
