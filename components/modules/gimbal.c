...
int32_t gimbal_cascade_register(struct gimbal *gimbal, const char *name, enum device_can can)
{
  ...
  pid_struct_init(&(gimbal->cascade[YAW_MOTOR_INDEX].outer), 500, 600, 45, 0, 10);
  ...
  pid_struct_init(&(gimbal->cascade[PITCH_MOTOR_INDEX].outer), 1000, 0, 70, 0.008, 0);
  pid_struct_init(&(gimbal->cascade[PITCH_MOTOR_INDEX].inter), 30000, 8000, 120, 0, 0);
