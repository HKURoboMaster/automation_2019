...
#define MOONROVER1_OFFLINE_EVENT EVENT_5BIT
#define MOONROVER2_OFFLINE_EVENT EVENT_6BIT
#define DUALMOTOR1_OFFLINE_EVENT    EVENT_7BIT
#define DUALMOTOR2_OFFLINE_EVENT  	EVENT_8BIT
